                    ...
                    {this.state.isActive && (
                      <div>
                        {/* 
                                                ...
                                                <----------------------------------------------------------------->
                                                */}
                        <form className="smart-form ng-pristine ng-valid">
                          <fieldset>
                            <div className="row">
                              <section>
                                ...
                                <label className="input">
                                  ...
                                  >
                                    ...
                                    {this.state.mess_schedule.map((objj) => {
                                      return (
                                        <option
                                          value={objj.canteenId}
                                          key={objj.canteenId}
                                        >
                                          {objj.canteenMealType}-
                                          {objj.canteenId}
                                        </option>
                                      );
                                    })}
                        ...
                        <div>
                          <div style={{ paddingTop: "10px" }}>
                            <table>
                              ...
                              <tbody>
                                {this.state.menudata.map((resp) => {
                                  return (
                                    <tr >
                                      
                                      <td>{resp.day.dayName}</td>
                                      <td>{resp.menu.menuName}</td>
                                      <td>{resp.mealtype.canteenMealType}</td>
                                      <td>{resp.dishes.dishName}</td>
                                    </tr>
                                  );
                                })}
                              </tbody>
