...
export default class Admaster extends Component {
    ...
    fetchmenu() {
        fetch("http://83.136.219.101:8080/erp/admission/getAdmissionProcessMasterEntry")
            .then(function (res) {
                return res.json();
            })
            .then((json) => {
    ...
    delete = (ItemId) => {
        if (window.confirm("aer you sure you want to delete"))
            axios
                .delete(
                    "http://83.136.219.101:8080/erp/admission/removeAdmissionProcessMasterEntry/" + ItemId
                )
                                                ...
                                                >
                                                    <fieldset>
                                                        ...
                                                        <section>
                                                            ...
                                                            <label className="input">
                                                                <select value={this.state.status} name="status" onChange={this.changeHandler} title="select your option">
