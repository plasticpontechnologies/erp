...
public class SectionController {
	  ...
	  @DeleteMapping(value ="/removeSectionDetails/{id}")
		...
		@GetMapping(value="/getsectionsbyid/{clId}")
		public List<SectionDetails> getSubjectDetails(@PathVariable("clId")int clId) {
			return sectionService.findSectionsById(clId);
